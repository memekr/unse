        ...
        {!isStarted ? (
          ...
          <>
            ...
            {showResult && (
              <>
                {/* 행운 아이템 추천 */}
                <section style={{ marginTop: '1.5rem', padding: '1.25rem', borderRadius: '1rem', background: 'linear-gradient(135deg, rgba(139,92,246,0.08), rgba(251,191,36,0.08))', border: '1px solid var(--color-border)', maxWidth: '36rem', width: '100%' }}>
